...
export const CoOpIncreasersFamily1: FamilyCardDataDef = {
...
export const OX_TOTEM_DEF: ITotemDetails = {
  ...
  playCards: [
    ...
    // { ...CoOpIncreasersFamily3 },
    // { ...CoOpIncreasersFamily3 },
    convertToFamilyCardDataDef(ForestHuntersCardData),
    convertToFamilyCardDataDef(GrasslandShepherdsCardData),
    convertToFamilyCardDataDef(RuggedShepherdsCardData),
    convertToFamilyCardDataDef(FarmersCardData),
    convertToFamilyCardDataDef(MysticFarmersCardData),
    convertToFamilyCardDataDef(SoylentGreenFarmersCardData),
  ],
}
